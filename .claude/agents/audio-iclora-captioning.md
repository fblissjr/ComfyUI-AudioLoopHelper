...
The effort map is `internal/audio_iclora_training/index.md` (private clone). Your canonical
doc is `internal/audio_iclora_training/data_plan.md` §0, §1, §1.1 (private clone only). READ IT —
