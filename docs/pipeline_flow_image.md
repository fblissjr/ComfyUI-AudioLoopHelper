...
|-------|-------|
| **Type** | `UNETLoader` |
| **Source** | ComfyUI core (`<home>/ComfyUI/nodes.py`) |
...
|-------|-------|
| **Type** | `VAELoaderKJ` |
| **Source** | KJNodes (`<home>/ComfyUI/custom_nodes/ComfyUI-KJNodes/nodes/ltxv_nodes.py`) |
...
| **Source** | `<home>/ComfyUI/custom_nodes/ComfyUI-MelBandRoFormer/nodes.py` |
...
| **Source** | ComfyUI core (`<home>/ComfyUI/comfy_extras/nodes_lt.py`) |
...
| **Source** | KJNodes (`<home>/ComfyUI/custom_nodes/ComfyUI-KJNodes/nodes/image_nodes.py`) |
...
| **Source** | KJNodes (`<home>/ComfyUI/custom_nodes/ComfyUI-KJNodes/nodes/model_optimization_nodes.py`) |
...
|-------|-------|
| **Type** | `TensorLoopOpen` |
| **Source** | `<home>/ComfyUI/custom_nodes/ComfyUI-NativeLooping_testing/nodes.py` |
...
| **Source** | `<home>/ComfyUI/custom_nodes/ComfyUI-AudioLoopHelper/nodes.py` |
...
| **Source** | `<home>/ComfyUI/custom_nodes/ComfyUI-LTXVideo/latents.py` |
...
| **Source** | `<home>/ComfyUI/custom_nodes/ComfyUI-VideoHelperSuite/` |
...
|--------------|-------------|
| AudioLoopHelper (AudioLoopController, TimestampPromptSchedule, ConditioningBlend, AudioLoopPlanner, AudioDuration) | `<home>/ComfyUI/custom_nodes/ComfyUI-AudioLoopHelper/nodes.py` |
| NativeLooping (TensorLoopOpen, TensorLoopClose) | `<home>/ComfyUI/custom_nodes/ComfyUI-NativeLooping_testing/nodes.py` |
| KJNodes: LTX2_NAG, LTXVChunkFeedForward, LTX2SamplingPreviewOverride, LTX2AttentionTunerPatch, LTXVImgToVideoInplaceKJ, LTXVAudioVideoMask | `<home>/ComfyUI/custom_nodes/ComfyUI-KJNodes/nodes/ltxv_nodes.py` |
| KJNodes: GetImageRangeFromBatch, GetImageSizeAndCount | `<home>/ComfyUI/custom_nodes/ComfyUI-KJNodes/nodes/image_nodes.py` |
| KJNodes: PathchSageAttentionKJ | `<home>/ComfyUI/custom_nodes/ComfyUI-KJNodes/nodes/model_optimization_nodes.py` |
| KJNodes: SetNode, GetNode, FloatConstant, INTConstant, ImageResizeKJv2, VisualizeSigmasKJ, VAELoaderKJ | `<home>/ComfyUI/custom_nodes/ComfyUI-KJNodes/` (various files) |
| LTXVideo: LTXVAddLatentGuide | `<home>/ComfyUI/custom_nodes/ComfyUI-LTXVideo/latents.py` |
| VideoHelperSuite: VHS_VideoCombine | `<home>/ComfyUI/custom_nodes/ComfyUI-VideoHelperSuite/` |
| MelBandRoFormer: MelBandRoFormerModelLoader, MelBandRoFormerSampler | `<home>/ComfyUI/custom_nodes/ComfyUI-MelBandRoFormer/nodes.py` |
| ComfyUI core: UNETLoader, DualCLIPLoader, CLIPTextEncode, LTXVConditioning, LTXVPreprocess, LTXVConcatAVLatent, LTXVSeparateAVLatent, LTXVCropGuides, EmptyLTXVLatentVideo, LTXVAudioVAEEncode, TrimAudioDuration, LoadAudio, LoadImage, VAEEncode, VAEDecode, CFGGuider, SamplerCustomAdvanced, KSamplerSelect, BasicScheduler, ModelSamplingSD3, RandomNoise, ConditioningZeroOut, SetLatentNoiseMask, SolidMask, ImageBatch, PrimitiveNode, Reroute, PreviewImage, PreviewAny, Note | `<home>/ComfyUI/comfy_extras/nodes_lt.py` and `<home>/ComfyUI/nodes.py` |
