...
| File | Lines | What |
|------|-------|------|
| `<comfyui_custom_nodes>/ComfyUI-LTXVideo/looping_sampler.py` | 722-729 | AV rejection check |
| `<comfyui_custom_nodes>/ComfyUI-LTXVideo/looping_sampler.py` | 241-309 | Spatial tiling (5D only) |
| `<comfyui_custom_nodes>/ComfyUI-LTXVideo/looping_sampler.py` | 310-523 | Temporal chunking |
| `<comfyui_core>/nested_tensor.py` | 1-92 | NestedTensor class |
| `<comfyui_extras>/nodes_lt.py` | 619-683 | ConcatAV / SeparateAV |
| `<comfyui_core>/ldm/lightricks/av_model.py` | 633-644 | separate/recombine latents |
| `<comfyui_core>/ldm/lightricks/av_model.py` | 1026-1059 | forward() AV handling |
