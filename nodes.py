...
# Loop-geometry math lives in the stdlib-only loop_geometry module so
# offline tooling (validate_workflow_decoder, apply_ltx_decoder) can use
# it without paying this module's torch import. Re-exported here for all
# existing consumers (node modules, tests).
try:
    ...
    from loop_geometry import (  # type: ignore[no-redef]
        LTX_TEMPORAL_SCALE,
        LoopGeometry,
        _compute_loop_geometry,
        _compute_tile_count,
